...
public class JuheRate {
	  public static final String DEF_CHATSET = "UTF-8";
	    ...
	    //配置您申请的KEY
	    public static final String APPKEY ="0139a11147ba11dde92eeb4502fe1bfe";
	     //1.常用汇率查询
	    ...
	    //3.实时汇率查询换算
	    public static JSONObject getRequest3(String from, String to){
	        String result =null;
	    ...
	    public static void main(String[] args) {
	    	JSONObject obj = getRequest3("JPY", "BHD");
	    	if (obj != null){
	    		 if(obj.getInteger("error_code")==0){
		                System.out.println(obj.get("result"));
		            }else{
		                System.out.println(obj.get("error_code")+":"+obj.get("reason"));
		            }
	    	}
	    }
