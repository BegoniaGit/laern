...
import ${servicePackageName}.Impl.${beanName}ServiceImpl;
import ${controllerPackageName}.${beanName}Controller;
...
public class ${beanName}ControllerTest {
    ...
    @Autowired
	public ${beanName}Controller testObject;
